...
<%
	...
	1) 우측 request객체로부터 RequestDispatcher를 받게해달라 
	request = > RequestDispatcher의 하수인임,, 하인 , 연장, 도구
	2) 좌항 dispatcher
	3) forward사용
	...
	※ 처리 과정 및 개념
	   ...
	   doGet()과 doPost()중 메소드를 호출해 주고 (실행시켜주고)
	   ...
	   이 『ServletContext』는『getSelevetContext』로만 받을 수 있다
