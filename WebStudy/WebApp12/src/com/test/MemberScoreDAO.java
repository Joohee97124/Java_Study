...
public class MemberScoreDAO
{
   ...
   //번호 검색 담당 메소드 
   public MemberScoreDTO search(String sid) throws SQLException //이름 얻어 내려고 함 
   {
       MemberScoreDTO result = new MemberScoreDTO();
       
       String sql = "SELECT SID, NAME, KOR, ENG, MAT FROM VIEW_MEMBERSCORE WHERE SID=?"; //Member 테이블 아님! 주의!
