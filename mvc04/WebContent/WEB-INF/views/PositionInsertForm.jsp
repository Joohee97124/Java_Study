	...
	<div id="content">
		...
		<form action="positioninsert.action" method="post" id="positionForm">
			...
			<tr>
				<th>직위명</th>
				<td>
					<input type="text" name="name" placeholder="직위명" id="name" />	
				</td>
			</tr>
			...
			<tr>
				<th>최소급여</th>
				<td>
					<input type="text" name="MinBasicPay" placeholder="최소급여" id="MinBasicPay" />	
				</td>
			</tr>
			
			<tr>
				<td colspan="2" align="center"><br /><br />
               <button type="button" style="width: 40%" class="btn" id="submitBtn">직위 추가</button>
