...
○ 중첩 클래스의 종류 (4가지)
	...
	1. static 중첩 클래스 (중첩 내부 클래스)
	   ...
	   외부 클래스의 인스턴스 변수나 인스턴스 메소드에는 접근 할 수 없고,
...
class Test
{
	...
	// static 내부 클래스
	public static class StaicNested
	{
		int c =30;
	...
	void print()
	{
		...
		StaicNested sn = new StaicNested();
		sn.write();
	}
}
...
public class Test117
{
	public static void main(String[] args)
	{
		...
		Test.StaicNested ob3 = new Test.StaicNested();
		ob3.write();
		//--==>> write()...
		//       a :10
		//       c :30
