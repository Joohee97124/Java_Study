...
○ 캐릭터 셋 (Character Set)
	...
	- 유니코드 (unicode)
	  ...
	  공식 명칭은 ISO/IEC 10646-1 (Universal Multiple-Otect Coded 
	  Character Set)이다
	...
	- UTF-8과 UTF-16
	  ...
	  ·UTF-16 (16bit UCS Transformation Format)
		...
		UTF-8과 병용할 수 있다.
		UCS-2로 이용하는 문자수를 대폭 늘릴 수 있다.

	※ 자바단에서는 UTF-16을 사용하고 웹이서는 UTF-8을 사용하기 때문에
...
public class Test136
{
	public static void main(String[] args) // throws UnsupportedEncodingException
	{
		...
		// 『String.getBytes()』
		// : 디폴트 캐릭터 셋을 기반으로 바이트 배열을 반환하는 메소드
		buf = name.getBytes();
		...
		try
		{
			...
			// System.out.println("value 1 : " + new String(바이트배열, 인코딩방식) );
			...
			// String 객체로 생성
			// System.out.println("valu 2 : " + new String(바이트배열) );
			System.out.println("valu 2 : " + new String(buf) );
			//--==>> valu 2 : 諛뺤젙以?
