...
public class Test160
{
	...
	{
		// List<String> list = new List<string>();	//-- List는 인터페이스라 객체 생성 불가능
		...
		// 2번 인스턴스 생성은... 생성과정에서 list1을 생성자에게 넘겨줌
		...
		// 출력 →ListIterator 를 활용하여 출력 → listIterator() 메소드 활용
		System.out.println("===========================");
		...
		// 출력 → 역순으로 출력 → ListIterator 를 활용하여 출력 
