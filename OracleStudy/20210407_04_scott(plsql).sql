...
--   TRUE 면 THEN과 ELSE 사이의 문장을 수행하고
--   FLASE나 NULL이면 ELSE와 END사이의 문장을 수행하게 된다
...
--   단, 반환 금액은 편의상 1천원 미만, 10원 이상만 가능한다고 가정한다.
/*
실행 예)
