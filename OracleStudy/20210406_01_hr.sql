...
-- 컬럼명 데이터타입,
-- 컬럼명 데이터타입,
-- CONSTRAINT XONSTRAINT명 CHECK(컬럼 조건)
...
--==>>
/*
HR	SYS_C007047	TBL_TEST8	C	COL3	COL3 BETWEEN 0 AND 100	(null)
HR	SYS_C007048	TBL_TEST8	P	COL1		(null)              (null)
*/
...
, CONSTRAINT TESTS9_COL3_CK CHECK(COL3 BETWEEN 0 AND 100)
);
...
--==>>
/*
HR	TESTS9_COL3_CK	TBL_TEST9	C	COL3	COL3 BETWEEN 0 AND 100
...
--○ 실습 문제
-- 다음과 같이 TBL_TESTMEMER 테이블을 생성하여
-- SSN 컬럼 (주민번호 컬럼) 에서
...
--==>>
/*
HR	TBL_TESTMEMBER_SID_PK	TBL_TESTMEMBER	P	SID	(null)	                               (null)
HR	TESTMEMBER_SSN_CK	    TBL_TESTMEMBER	C	SSN	SUBSTR(SSN,8,1) IN ('1','2','3','4'))  (null)
*/

-- 데이터 입력 테스트
INSERT INTO TBL_TESTMEMBER(SID, NAME, SSN, TEL)
VALUES (2, '소서현', '920718-2234567', '010-1111-1111');

INSERT INTO TBL_TESTMEMBER(SID, NAME, SSN, TEL)
VALUES (3, '박정준', '961031-1234567', '010-2222-2222');

INSERT INTO TBL_TESTMEMBER(SID, NAME, SSN, TEL)
VALUES (4, '안정미', '060125-4234567', '010-3333-3333');

INSERT INTO TBL_TESTMEMBER(SID, NAME, SSN, TEL)
VALUES (5, '한혜림', '071006-3234567', '010-4444-4444');

INSERT INTO TBL_TESTMEMBER(SID, NAME, SSN, TEL)
VALUES (6, '이상화', '940514-5234567', '010-5555-5555');
--==>> 에러 발생
/*
...
INSERT INTO TBL_TESTMEMBER(SID, NAME, SSN, TEL)
VALUES (7, '정주희', '971224-6234567', '010-6666-6666');
--==>> 에러 발생
/*
ORA-02290: check constraint (HR.TESTMEMBER_SSN_CK) violated
*/
...
--==>>
/*
1	정주희	971224-2055555	010
2	소서현	920718-2234567	010-1111-1111
3	박정준	961031-1234567	010-2222-2222
4	안정미	060125-4234567	010-3333-3333
5	한혜림	071006-3234567	010-4444-4444
*/
...
--==>>
/*
HR	SYS_C007059	TBL_EMP1	P	SID		
HR	SYS_C007060	TBL_EMP1	R	JIKWI_ID		NO ACTION
*/
...
--==>>
/*
HR	EMP2_SID_     PK	TBL_EMP2	P	SID		
...
--==>>
/*
HR	EMP3_SID_     PK	TBL_EMP3	P	SID		
...
--==>> 에러 발생
/*
ORA-02292: integrity constraint (HR.SYS_C007060) violated - child record found
*/
...
-- 3. 기존에 생성되어 있는 테이블에 NOT NULL 제약조건을 추가 할 경우
...
--==>>
/*
HR	SYS_C007066	TBL_TEST11	C	COL2	"COL2" IS NOT NULL	
HR	SYS_C007067	TBL_TEST11	P	COL1		
*/
...
--※ 테이블 생성 이후 ADD를 통해 NOT NULL 제약조건을 추가한 테이블
DESC TBL_TEST13;
--==>>
/*
이름   널?       유형           
...
--※ 테이블 생성 이후 MODIFY절을 통해 NOT NULL 제약조건을 추가한 테이블
DESC TBL_TEST14;
--==>>
/*
이름   널?       유형           
