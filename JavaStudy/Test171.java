...
○ Serializable 인터페이스
   ...
   - 객체 직렬화를 하기 위해 먼저 객체 직렬화가 가능하도록
	 ...
	 ② 
	 Serializable 인텊페이스를 구현한 후
	 ObjectInputStream 클래스와 ObejctOutputStream 클래스를 이용하여
	 객체 단위로 입출력을 수행하게 된다.
...
○ Object Stream
	...
	- java.io.ObjectInputStream
	  ...
	  파일에 저장되어 있는 객체나 네트워크를 통해 전달된 객체이
	  직렬화를 해제하는 기능을 제공한다.
